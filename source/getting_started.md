...
Чтобы это исправить для версии Rails 4, необходимо раскомментировать строку  #root 'welcome#index' в файле ~/config/routes.rb.

Если произойдет другой запрос, такой как http://localhost:3000/welcome, будет отдан файл `public/welcome.html`, но только если он существует.
